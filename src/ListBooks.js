       ...
       return(
        <div className="list-books">
            ...
            <div className="list-books-content">
                <div>
                    <BookShelf listFormattedName='Currently Reading' listName='currentlyReading'/>
                    <BookShelf listFormattedName='Read' listName='read'/>
                    <BookShelf listFormattedName='Want to Read' listName='wantToRead'/>
